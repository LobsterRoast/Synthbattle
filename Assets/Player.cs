...
public class Player : MonoBehaviour
{
    ...
    private Transform particle_rotator;
    ...
    void Start()
    {
        ...
        particle_rotator = GameObject.FindWithTag("ParticleRotator").transform;
    }
    ...
    {
        Instantiate(projectile, transform.position, transform.rotation, particle_rotator);
    }
}
